...
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
      ...
      $n=$_SESSION['namee'];
      $result=mysqli_query($con,"SELECT * FROM evidence_master WHERE uname='".$n. "'");
    ...
    echo"</tr>";
    echo "<tr>";
    echo "<th>Investigation ID :</th>";
    echo "<td>" . $row['investigation_id'] . "</td>";
    echo"</tr>";
    echo"<tr>";
    echo "<th>Evidence Type ID :</th>";
    echo "<td>" . $row['evidence_type_id'] . "</td>";
    echo "</th>";
    echo"<tr>";
    echo "<th>Evidence Date:</th>";
    echo "<td>" . $row['evidence_date'] . "</td>";
    echo"</tr>";
echo "</table>";
echo "</center>";
mysqli_close($con);

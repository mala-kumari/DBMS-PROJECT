...
if(isset($_POST['register']) && !empty($_POST["subject"]) && !empty($_POST["content"]))
{
  ...
  $content = $_POST['content'];  
   ...
   $result = "INSERT INTO msgg(heading_g,content_c) VALUES ('$subject','$content')";
  
   $output = mysqli_query($connection,$result);
  if($output)
  {
     echo"<h3>Masseges sent!</h3>";
  }
...
<body class="bg">
 ...
 <img src="mg.jpg" class="image"/> 
<div class="card">
  <form action="msg.php" method="post" >
    <label class="required">Subject</label><br>
    <input type="text" name="subject" placeholder="Subject..."><br>

    <label class="required">Massages</label><br>

    <input type="text" name="content" placeholder="Your Complaint..." rows="4"><br>
    <br>
    <center>
      <button type="register" name="register">Send Messages</button>
    </center>
  </form>
</div>

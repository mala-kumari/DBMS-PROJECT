...
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
      ...
      $n=$_SESSION['namee'];
      $result=mysqli_query($con,"SELECT * FROM post WHERE uname='".$n. "'");
    ...
    echo"</tr>";
    echo"<tr>";
    echo "<th>External Injury:</th>";
    echo "<td>" . $row['exter'] . "</td>";
    echo"</tr>";
    echo"<tr>";
    echo "<th>Internal Injury:</th>";
    echo "<td>" . $row['inter'] . "</td>";
    echo"</tr>";
    echo"<tr>";
    echo "<th>Postmortem Starting time:</th>";
    echo "<td>" . $row['pst'] . "</td>";
    echo"</tr>";
    echo"<tr>";
    echo "<th>Postmortem Ending time:</th>";
    echo "<td>" . $row['pet'] . "</td>";
    echo"</tr>";
echo "</table>";
echo "</center>";
...
$sql = "DELETE FROM crime_category_master WHERE user_id='".$ver."'";

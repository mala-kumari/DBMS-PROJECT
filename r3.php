...
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
      ...
      $n=$_SESSION['namee'];
      $result=mysqli_query($con,"SELECT * FROM department_master WHERE us_name='".$n. "'");
    ...
    echo "</th>";
    echo"<tr>";
    echo "<th>Higtest Designation Id :</th>";
    echo "<td>" . $row['highest_designation_id'] . "</td>";
    echo"</tr>";
echo "</table>";
echo "</center>";
...
$sql = "DELETE FROM department_master WHERE user_id='".$ver."'";

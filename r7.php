...
<body bgcolor="lightblue">
    <center>
    <h2><u> CRIME  CATEGORY  MASTER</u></h2>
</center>
...
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
    ...
    $n=$_SESSION['namee'];
    $result=mysqli_query($con,"SELECT * FROM crime_category_master WHERE uname='".$n. "'");
    ...
    echo "<table>";
    echo "<tr>";
    echo"<th>Crime Category ID :</th>";
    echo "<td>" . $row['crime_category_id'] . "</td>";
    echo"</tr>";
    echo "<tr>";
    echo "<th>Crime Category Name :</th>";
    echo "<td>" . $row['crime_category_name'] . "</td>";
    echo"</tr>";
    echo"<tr>";
...
?>
<center>
<form action="r7.php" method="post">

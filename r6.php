...
<body bgcolor="lightblue">
    <center>
    <h2><u>POLICE STATION MASTER</u></h2>
</center>
...
<?php
session_start();
$connn=mysqli_connect('localhost','root','','crime_management');
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
}
   $n= $_SESSION['namee'];
   $result=mysqli_query($connn,"SELECT * FROM police_station_master WHERE uname='".$n. "'");
...
echo"<table>";
    ...
    echo"</tr>";
    echo"<tr>";
    echo "<th>Territory ID :</th>";
   echo "<td>" . $row['territory_id'] . "</td>";
   echo "</tr>";
   echo"<tr>";
  ...
  echo"</tr>";
  echo"<tr>";
   echo "<th>Incharge ID.:</th>";
  echo "<td>" . $row['incharge_id'] . "</td>";
  echo"</tr>";
  echo"<tr>";
   echo "<th>FLAT NO. :</th>";
...
$sql = "DELETE FROM police_station_master WHERE user_id='".$ver."'";

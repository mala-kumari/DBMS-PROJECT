...
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
    ...
    $n=$_SESSION['namee'];
    $result=mysqli_query($con,"SELECT * FROM designation_master WHERE user='".$n. "'");
    ...
    echo"</tr>";
    echo"<tr>";
    echo "<th>Designation Description :</th>";
    echo "<td>" . $row['Designation_desc'] . "</td>";
    echo"</tr>";
    echo "<tr>";
    echo "</table>";
    echo "</center>";
...
$sql = "DELETE FROM designation_master WHERE user_id='".$ver."'";

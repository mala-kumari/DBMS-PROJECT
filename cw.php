...
<body bgcolor="lightblue">
    <center>
    <h2><u>CRIME WITNESS MASTER</u></h2>
</center>
...
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
      ...
      $n=$_SESSION['namee'];
      $result=mysqli_query($con,"SELECT * FROM crime_witness WHERE uname='".$n. "'");
      $row=mysqli_fetch_array($result);
      echo"<center>";
      echo "<table>";
    echo "<tr>";
    echo"<th>WITNESS ID :</th>";
    echo "<td >" . $row['witness_id'] . "</td>";
    echo"</tr>";
    echo "<tr>";
    echo "<th>FIR NO. :</th>";

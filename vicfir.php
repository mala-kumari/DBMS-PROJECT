...
if(mysqli_connect_error())
{
 echo "Failed to connect to mysql:" .mysqli_connect_error(); 
      ...
      $n=$_SESSION['namee'];
      $result=mysqli_query($con,"SELECT * FROM victim_fir_master WHERE uname='".$n. "'");
      $row=mysqli_fetch_array($result);
      echo"<center>";
      echo "<table>";
    echo "<tr>";
    echo"<th>Victim FIR ID :</th>";
    echo "<td >" . $row['victim_fir_id'] . "</td>";
    echo"</tr>";
    echo "<tr>";
    echo "<th>Crime Nature ID :</th>";
    echo "<td>" . $row['crime_nature_id'] . "</td>";
    echo"</tr>";
    echo"<tr>";
    echo "<th>Address :</th>";
    ...
    echo "</th>";
    echo"<tr>";
    echo "<th>Location Details :</th>";
    echo "<td>" . $row['location_detail'] . "</td>";
    echo"</tr>";
    echo"<tr>";
    echo "<th>Registration Date:</th>";
    echo "<td>" . $row['regitration_date'] . "</td>";
    echo"</tr>";
    echo"<tr>";
    ...
    echo"</tr>";
    echo"<tr>";
    echo "<th>Investigation Officer ID:</th>";
    echo "<td>" . $row['investigation_officer_id'] . "</td>";
    echo"</tr>";
    echo"<tr>";

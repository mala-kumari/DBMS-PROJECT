...
if(isset($_POST['regi']))
{
  ...
  $dobb=$_POST['dob_name'];
  $passw=$_POST['psw'];
  $result="INSERT INTO people(naame,email,mobile,dob,p_password)VALUES('$nnm','$ema','$mob','$dobb','$passw')";
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="sighin.php" method="post">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <img src="sym.jpg" alt="Avatar" class="avatar">
    </div>
    ...
    <div class="container">
      ...
      <button type="submit" name="regi">Registerd</button>
      <label>
